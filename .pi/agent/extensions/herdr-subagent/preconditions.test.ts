...
const capabilities: HerdrCapabilities = { protocol: HERDR_PROTOCOL, version: "0.8.0", snapshot: true, tabs: true, agents: true, panes: true, layout: true, events: true, fixedInterrupt: true };
