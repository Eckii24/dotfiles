...
3. Read the referenced specification, implementation plan, and changed files
4. Run the relevant eval/test/build commands from the plan when possible
5. Review for spec compliance, correctness, security, performance, maintainability, and test coverage
