...
return {
  ...
  },
  {
    ...
    keys = {
      { "<leader>T", desc = "TaskWarrior" },
      { "<leader>Te", "<cmd>TWEditTask<cr>", desc = "TaskWarrior Edit" },
      { "<leader>Tr", "<cmd>TWRunWithCurrent<cr>", desc = "TaskWarrior Run with Current" },
      { "<leader>Td", "<cmd>TWRunWithCurrent done<cr>", desc = "TaskWarrior Mark Done" },
      { "<leader>TD", "<cmd>TWRunWithCurrent mod status:pending<cr>", desc = "TaskWarrior Mark Pending" },
