...
# Azure Open AI for pi
export AZURE_OPENAI_API_KEY="op://Employee/AzureFoundry/password"
export AZURE_OPENAI_BASE_URL="op://Employee/AzureFoundry/BASE"
export AZURE_OPENAI_DEPLOYMENT_NAME_MAP="op://Employee/AzureFoundry/MAP"
